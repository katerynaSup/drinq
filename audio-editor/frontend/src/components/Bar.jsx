...
import { faMortarPestle, faGlassWater, faMagicWandSparkles } from '@fortawesome/free-solid-svg-icons';

const Bar = ({ barItems, isOpen, onClose, onGenerateDrinks }) => {
    ...
    return (
        <div className="bar-overlay" onClick={(e) => {
            if (e.target.className === 'bar-overlay') onClose();
        }}>
